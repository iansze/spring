...
const Movie = ({ data }: MovieProps) => {
  ...
  return (
    <div className="h-[200px] md:h-[300px]  lg:h-[400px] group relative overflow-hidden ">
      <div className="h-full w-full absolute top-0 bg-gradient-to-r from-gray-900 from-30% to-gray-400 opacity-50 z-10" />
      <div className={`absolute w-full h-full bg-black ${fadeOutEffect} z-20 `} />
      <div className="h-full  absolute top-0  -z-10 ">
